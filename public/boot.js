...
const config = {
    ...
    state: {
        keoda: {
            db,
            lexicon: Object.assign({}, ...types_1.TYPES.map(type => ({ [type]: Object.keys(db[type]).sort() })), { phrase: Object.keys(db.phrase).sort(phraseSort) }),
        },
    },
    actions: {
        keoda: actions,
...
const Entry = ({ className, id, popup }) => {
    ...
    return (React.createElement(Wrapper, { className: classnames_1.default(entry.type, className, {
        ...
        entry.type === 'phrase' ? (React.createElement(Name, { className: "Name phrase" },
            React.createElement(Link_1.Link, { id: id, fromMd: true }))) : (React.createElement(Name, { className: "Name" },
        ...
        React.createElement(Definitions, null,
            ...
            entry.phrases && (React.createElement(Definition, { className: "desc" },
                React.createElement(List_1.List, { className: "phrases", entries: entry.phrases }))))));
};
exports.Entry = Entry;
...
`;
const Link = ({ className, id, fromMd, children }) => {
    const ctx = app_1.useOvermind();
    if (id.startsWith('http')) {
        return (React.createElement(Anchor, { href: id, children: children, className: "out", target: "_blank" }));
    }
    const [type] = id.split('-');
    if (type === 'phrase') {
    ...
    let timer;
    return (React.createElement(Wrapper, { className: classnames_1.default('Link', className, {
            ref: fromMd,
...
const renderers = {
    link: ({ href, children, }) => {
        return React.createElement(Link_1.Link, { id: href, fromMd: true, children: children });
    },
};
...
const Phrase = ({ className, id }) => {
    ...
    return (React.createElement(Wrapper, { className: className },
        ...
        glo ? (React.createElement(GWrap, null,
            ...
            React.createElement(List_1.List, { phrase: true, entries: phrase.words, glo: glo }))) : (React.createElement(List_1.List, { phrase: true, entries: phrase.words, glo: glo }))));
};
